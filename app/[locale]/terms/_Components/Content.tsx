    ...
    <section className="relative w-full md:-mt-[90px] -mt-[105px]">
      ...
      <div className="flex flex-col md:gap-16 gap-10 relative container px-3 mx-auto ">
        ...
        <motion.section
          ...
          <motion.p className="md:ms-6 ms-5 text-base md:text-[19px]">
            {t('Intellectual Property Rights desc')}
          </motion.p>
        </motion.section>
        ...
        <motion.section
          ...
          <motion.ul
            ...
            <motion.li
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}>
              {t('User Conduct desc 2')}
            </motion.li>
            <motion.li
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}>
              {t('User Conduct desc 3')}
            </motion.li>
            <motion.li
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}>
              {t('User Conduct desc 4')}
            </motion.li>
          </motion.ul>
        </motion.section>
