  ...
  return (
    <section className="relative w-full bg-[#fbfbfb]  overflow-hidden">
      ...
      <motion.div
        ...
        className="hidden lg:block absolute top-0 left-20 w-3 h-3 bg-secondery-normal rotate-45"
      />
      <motion.div
        initial={{ opacity: 0, rotate: 0 }}
        animate={{ opacity: 1, rotate: 45 }}
            ...
            >
              ...
              >
                <motion.p
                  ...
                  viewport={{ once: true, margin: "-100px" }}
                  transition={{ duration: 0.6, delay: 0.3 }}
                  className="text-sm sm:text-base text-black/50 font-medium md:max-w-4/5 capitalize leading-relaxed"
                >
