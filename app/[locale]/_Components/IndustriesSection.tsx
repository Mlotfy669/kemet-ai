        ...
        >
          {industries.map((industry, index) => (
            <motion.div
              ...
              className="bg-white rounded-[10px] border border-[#f3f3f3] shadow-[0px_61.49px_76.86px_0px_rgba(185,192,201,0.2)] lg:p-6 lg:pb-10 md:p-4 md:pb-8 p-4 pb-6 flex flex-col lg:gap-5 md:gap-4 gap-3 items-center text-center cursor-pointer"
            >
              <motion.h3
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
