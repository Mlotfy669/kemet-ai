...
const svgPaths = {
  ...
  p35fcd280: "M11.5063 8.25426C11.945 8.01947 12.4773 8.04521 12.8913 8.32121L20.9864 13.7179C21.3618 13.9682 21.5872 14.3894 21.5872 14.8405C21.5872 15.2916 21.3618 15.7129 20.9864 15.9631L12.8913 21.3598C12.4773 21.6358 11.945 21.6616 11.5063 21.4268C11.0676 21.192 10.7938 20.7348 10.7938 20.2372V9.4438C10.7938 8.94622 11.0676 8.48904 11.5063 8.25426ZM13.4921 11.9648V17.7163L17.8058 14.8405L13.4921 11.9648Z",
...
function TestimonialCard({ name, testimonial, image, index, t }: TestimonialCardProps) {
  return (
    <motion.div
