...
const industries = [
  {
    ...
    description: "Accuracy & Context desc",
  },
  {
    title: "Operational Efficiency",
    description: "Operational Efficiency desc",
  },
  {
    title: "Compliance & Security",
    description: "Compliance & Security desc",
  },
  {
    title: "Cross-Lingual Excellence",
    description: "Cross-Lingual Excellence desc",
  }
];
  ...
  return (
    <section className="relative w-full lg:py-20 py-12">
      ...
      >
        ...
        >
          {t("Awareness: Accurate retrieval, superior speed, and unparalleled security")}
        </motion.h2>
