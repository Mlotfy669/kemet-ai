        ...
        <div className={`flex h-full items-start md:flex-row flex-col xl:gap-20 lg:gap-12 md:gap-8 gap-8 mx-auto`}>
          ...
          >
            ...
            <motion.h1
              ...
              className={`font-bold leading-snug relative z-10 ${locale === "ar" ? "md:w-4/5 2xl:text-[53px] xl:text-[48px] lg:text-[44px] md:text-[36px] text-[27px]" : "2xl:text-7xl xl:text-[50px] lg:text-[44px] md:text-[40px] text-[30px]"}`}
            >
              <Image
                src={underline}
                alt="Title underline"
