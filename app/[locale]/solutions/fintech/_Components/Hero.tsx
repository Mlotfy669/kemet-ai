      ...
      <div className="container h-full mx-auto relative px-6 2xl:py-20 xl:py-6 lg:py-10 md:py-10 py-6">
        <div className={`flex h-full items-start md:flex-row flex-col xl:gap-20 lg:gap-12 md:gap-8 gap-8 mx-auto`}>
          ...
          <motion.div
            ...
            className="text-white flex flex-col xl:gap-2 lg:gap-7 gap-10"
          >
            ...
            <motion.h1
              ...
              className={`font-bold leading-snug relative z-10 ${locale === "ar" ? "2xl:text-[53px] xl:text-[48px] lg:text-[44px] md:text-[36px] text-[30px]" : "2xl:text-7xl xl:text-[50px] lg:text-[44px] md:text-[40px] text-[33px]"}`}
            >
              <Image
                src={underline}
                alt="Title underline"
