...
import security from "@/public/assets/solutions/vision-analysis/security.png";
...
export default function IntegratedServices() {
  ...
  return (
    <section className="relative w-full bg-[#fbfbfb] py-8 sm:py-12 md:py-10 lg:py-10 overflow-hidden">
      <motion.div
      ...
      >
        ...
        >
          ...
          >
            {t("Security and Sovereignty in Image and Video Processing")}
          </motion.h1>
          ...
          >
            {t("Security and Sovereignty in Image and Video Processing desc")}
          </motion.p>
        </motion.div>
