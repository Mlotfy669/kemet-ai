          ...
          >
            ...
            >
              <motion.h1
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.4 }}
                className={`font-bold leading-tight relative z-10 ${locale === "ar" ? "md:w-4/5 mb-4 2xl:text-6xl xl:text-[52px] lg:text-[44px] md:text-[36px] text-[32px]" : "2xl:text-7xl xl:text-[50px] lg:text-[44px] md:text-[40px] text-[32px]"}`}
              >
                <Image
                  src={underline}
                  alt="Title underline"
