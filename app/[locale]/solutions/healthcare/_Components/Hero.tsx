          ...
          >
            ...
            >
              ...
              <motion.span
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.4 }}
                className={`2xl:w-[75%] xl:w-[85%] md:w-[90%] flex font-bold leading-loose relative z-10 ${locale === "ar" ? "2xl:text-[40px] xl:text-[30px] lg:text-[28px] md:text-[26px] text-[24px]" : "2xl:text-3xl xl:text-[30px] lg:text-[28px] md:text-[26px] text-[24px]"}`}
              >
