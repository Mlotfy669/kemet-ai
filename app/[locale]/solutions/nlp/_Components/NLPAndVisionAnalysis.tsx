...
import dataPrivicy from "@/public/assets/solutions/nlp/nlp-and-vision.webp"
import { motion } from "framer-motion";
import { useTranslations } from "next-intl";
import Image from "next/image";


export default function NLPAndVisionAnalysis() {

  const t = useTranslations()


  return (
    <section className="relative w-full bg-[#fbfbfb] py-10 overflow-hidden">
      <motion.div
      ...
      >
        ...
        >
          ...
          >
            {t("NLP and Vision Analysis")} : <br />
            {t("Comprehensive Data Transformation")}
          </motion.h1>
          ...
          >
            {t("NLP and Vision Analysis desc")}
          </motion.p>
