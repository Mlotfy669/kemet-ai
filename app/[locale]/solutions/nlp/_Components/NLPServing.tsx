...
const industries = [
  {
    ...
    description: "Sentiment Analysis desc",
  },
  {
    title: "Intent Detection",
    description: "Intent Detection desc",
  },
  {
    title: "Brand Mention & Reputation Scoring",
    description: "Brand Mention & Reputation Scoring desc",
  },
  {
    title: "Entity Recognition & Linking",
    description: "Entity Recognition & Linking desc",
  },
  {
    title: "Emotion Detection",
    description: "Emotion Detection desc",
  },
  {
    title: "Relevance Scoring / Content Ranking",
    description: "Relevance Scoring / Content Ranking desc",
  },
  {
    title: "Text Summarization",
    description: "Text Summarization desc",
  },
  {
    title: "Language & Dialect Detection",
    description: "Language & Dialect Detection desc",
  },
    ...
    <section className="relative w-full lg:py-20 py-12">
      ...
      >
        ...
        <motion.h2
          ...
          className="lg:text-4xl text-2xl text-center mx-auto font-bold text-black mb-3"
        >
          {t("NLP Serving Compliance and Intelligence")}
        </motion.h2>
