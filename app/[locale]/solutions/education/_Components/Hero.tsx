...
import hero from "@/public/assets/solutions/education/hero.webp";
...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-screen hero-bg mb-20 lg:mb-40">
      ...
      <div className="container h-full mx-auto relative px-6 2xl:py-32 xl:py-6 lg:py-10 md:py-20 py-10">
          ...
          >
            ...
            >
              ...
              <motion.span
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.4 }}
                className={` flex font-bold leading-loose relative z-10 ${locale === "ar" ? "md:w-[70%] 2xl:text-4xl xl:text-[30px] lg:text-[28px] md:text-[26px] text-[24px]" : "2xl:text-3xl xl:text-[30px] lg:text-[28px] md:text-[26px] text-[24px]"}`}
              >
                {t("Institutional Knowledge Management & Academic Efficiency")}
              </motion.span>
            </motion.div>
